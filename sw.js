...
self.addEventListener("fetch", e => {
  ...
  /* El armario inicial nunca se cachea: es el archivo que cambia por persona
     y servir el de otro cliente seria un desastre. */
  if (req.url.includes("armario_inicial.json")) {
